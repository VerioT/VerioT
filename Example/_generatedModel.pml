...
#define DEVICE1 0
#define DEVICE2 1
#define DELEGATORCLOUD 2
#define DELEGATEECLOUD 3
#define DELEGATEEUESER 4

// definiation of ID
#define IDDEVICE1 1
#define IDDEVICE2 2
#define IDDELEGATORCLOUD 3
#define IDDELEGATEECLOUD 4
#define IDDELEGATEEUESER 5
...
inline bind1(){
    ...
    atomic {
        // share IDDEVICE1 with DELEGATORCLOUD
        // add IDDEVICE1 to DEVICE1 SCL and DELEGATORCLOUD RCL
        printf("bind1_1 ");
        printf("DEVICE1 DELEGATORCLOUD\n");
        addItemSCL(DEVICE1, IDDEVICE1);
        addItemRCL(DELEGATORCLOUD, IDDEVICE1);
...
inline unbind1(){
    ...
    atomic {
        // remove the IDDEVICE1 in DELEGATORCLOUD RCL
        printf("unbind1_4 ");
        printf("DEVICE1 DELEGATORCLOUD\n");
        removeItemRCL(DELEGATORCLOUD, IDDEVICE1);
...
inline bind2(){
    ...
    atomic {
        // share IDDEVICE2 with DELEGATORCLOUD
        // add IDDEVICE2 to DEVICE2 SCL and DELEGATORCLOUD RCL
        printf("bind2_1 ");
        printf("DEVICE2 DELEGATORCLOUD\n");
        addItemSCL(DEVICE2, IDDEVICE2);
        addItemRCL(DELEGATORCLOUD, IDDEVICE2);
...
inline unbind2(){
    ...
    atomic {
        // remove the IDDEVICE2 in DELEGATORCLOUD RCL
        printf("unbind2_4 ");
        printf("DEVICE2 DELEGATORCLOUD\n");
        removeItemRCL(DELEGATORCLOUD, IDDEVICE2);
...
inline OAuth1(){
    ...
    atomic {
        ...
        // add to DELEGATORCLOUD GCL and  DELEGATEECLOUD RCL 
        printf("OAuth1_1 ");
        printf("DELEGATORCLOUD DELEGATEECLOUD\n");
        newCredential --;
        addItemGCL(DELEGATORCLOUD, DELEGATEECLOUD, newCredential);
        addItemRCL(DELEGATEECLOUD, newCredential);
...
inline unOAuth1(){
    ...
    atomic {
        ...
        // remove the DELEGATEECLOUD's token from DELEGATORCLOUD's GCL
        printf("unOAuth1_1 ");
        printf("DELEGATORCLOUD DELEGATEECLOUD\n");
        removeItemGCL(DELEGATORCLOUD, DELEGATEECLOUD);
...
inline share1(){
    ...
    atomic {
        // add IDDELEGATEEUESER to DELEGATEECLOUD ACL
        printf("share1_1 ");
        ...
        printf("share1_2 ");
        printf("DELEGATEECLOUD DELEGATEEUESER\n");
        addRCLstoRCLs(DELEGATEECLOUD, DELEGATEEUESER);
...
inline unshare1(){
    ...
    atomic {
        // remove IDDELEGATEEUESER from DELEGATEECLOUD ACL
        printf("unshare1_1 ");
        printf("DELEGATEECLOUD DELEGATEEUESER\n");
        removeItemACL(DELEGATEECLOUD, IDDELEGATEEUESER);
...
inline APIRequest1(){
    ...
    atomic {
        // add everything in DELEGATORCLOUD RCL to DELEGATEEUESER RCL
