...
inline assertionunbind1(){
    atomic{
        ...
        calAllAccessPaths(GOOGLEHOMEUSER, AUGUSTLOCK, VOLFlagunbind1);
    }
}
...
inline assertionunbind2(){
    atomic{
        ...
        calAllAccessPaths(GOOGLEHOMEUSER, AUGUSTLOCK, VOLFlagunbind2);
        calAllAccessPaths(GOOGLEHOMEUSER, SMARTTHINGSSWITCH, VOLFlagunbind2);
    }
}
...
inline assertionunOAuth1(){
    atomic{
        ...
        calAllAccessPaths(GOOGLEHOMEUSER, AUGUSTLOCK, VOLFlagunOAuth1);
        calAllAccessPaths(GOOGLEHOMEUSER, SMARTTHINGSSWITCH, VOLFlagunOAuth1);
    }
}
...
inline assertionunshare1(){
    atomic{
        ...
        calAllAccessPaths(GOOGLEHOMEUSER, AUGUSTLOCK, VOLFlagunshare1);
        calAllAccessPaths(GOOGLEHOMEUSER, SMARTTHINGSSWITCH, VOLFlagunshare1);
    }
}
...
proctype IoTDelegation(){
    atomic{
        ...
        do
            :: ACVbind1 == 0 ->
                atomic{
                    printf("bind1 AUGUSTLOCK SMARTTHINGSCLOUD \n");
                    bind1(AUGUSTLOCK, SMARTTHINGSCLOUD);
                    ACVbind1 = 1;
                }
            ...
            :: ACVOAuth1 == 0 && ACVbind2 == 1 ->
                atomic{
                    printf("OAuth1 SMARTTHINGSCLOUD GOOGLEHOMECLOUD SMARTTHINGSSWITCH \n");
                    OAuth1(SMARTTHINGSCLOUD, GOOGLEHOMECLOUD, SMARTTHINGSSWITCH);
                    ACVOAuth1 = 1;
                }

            :: ACVshare1 == 0 && ACVbind2 == 1 && ACVOAuth1 == 1 ->
                atomic{
                    printf("share1 GOOGLEHOMECLOUD GOOGLEHOMEUSER SMARTTHINGSSWITCH \n");
                    share1(GOOGLEHOMECLOUD, GOOGLEHOMEUSER, SMARTTHINGSSWITCH);
                    ACVshare1 = 1;
                }
    ...
    do
        ...
        :: ACVOAuth1 == 1 ->
            atomic{
                printf("unOAuth1 SMARTTHINGSCLOUD GOOGLEHOMECLOUD SMARTTHINGSSWITCH \n");
                unOAuth1(SMARTTHINGSCLOUD, GOOGLEHOMECLOUD, SMARTTHINGSSWITCH);
                ACVOAuth1 = 2;
                assertionunOAuth1();
            }
        ...
        :: ACVshare1 == 1 ->
            atomic{
                printf("unshare1 GOOGLEHOMECLOUD GOOGLEHOMEUSER SMARTTHINGSSWITCH \n");
                unshare1(GOOGLEHOMECLOUD, GOOGLEHOMEUSER, SMARTTHINGSSWITCH);
                ACVshare1 = 2;
                assertionunshare1();
            }
